...
/**
 * Dialog pro filtraci období měsíčních odečtů.
 */
public class MonthlyReadingFilterDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(getString(R.string.filtr_nastav), (dialog, which) -> {
        ...
        builder.setNegativeButton(getString(R.string.zrusit), (dialog, which) -> {
        });
