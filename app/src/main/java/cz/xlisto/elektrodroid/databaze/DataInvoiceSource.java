...
import static cz.xlisto.elektrodroid.databaze.DbHelper.CISLO_FAK;
...
import static cz.xlisto.elektrodroid.databaze.DbHelper.NT_KON;
import static cz.xlisto.elektrodroid.databaze.DbHelper.ODBER_ID;
import static cz.xlisto.elektrodroid.databaze.DbHelper.TABLE_NAME_INVOICES;
import static cz.xlisto.elektrodroid.databaze.DbHelper.VT;
import static cz.xlisto.elektrodroid.databaze.DbHelper.VT_KON;
...
public class DataInvoiceSource extends DataSource {
    ...
    private ContentValues createContentValue(InvoiceModel invoice) {
        ...
        if (invoice.isChangedElectricMeter())
